...
class ICalCalendar {
    ...
    method(method) {
        ...
        this.data.method = tools_1.checkEnum(ICalCalendarMethod, method);
        return this;
    }
    name(name) {
        if (name === undefined) {
    ...
    ttl(ttl) {
        ...
        if (tools_1.isMomentDuration(ttl)) {
    ...
    save(path, cb) {
        if (cb) {
            fs_1.writeFile(path, this.toString(), cb);
            return this;
        }
     ...
     */
    saveSync(path) {
        fs_1.writeFileSync(path, this.toString());
        return this;
    }
    /**
    ...
    toString() {
        ...
        // TTL
        if (this.data.ttl) {
            g += 'REFRESH-INTERVAL;VALUE=DURATION:' + tools_1.toDurationString(this.data.ttl) + '\r\n';
            g += 'X-PUBLISHED-TTL:' + tools_1.toDurationString(this.data.ttl) + '\r\n';
        }
        // Events
