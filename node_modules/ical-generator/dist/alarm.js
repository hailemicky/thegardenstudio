...
class ICalAlarm {
    ...
    trigger(trigger) {
        ...
        if (!trigger) {
            ...
            this.data.trigger = tools_1.checkDate(trigger, 'trigger');
        }
        return this;
    }
    ...
    toJSON() {
        ...
        return Object.assign({}, this.data, {
            trigger: typeof trigger === 'number' ? trigger : tools_1.toJSON(trigger),
            x: this.x()
        });
    }
    /**
    ...
    toString() {
        ...
        if (typeof this.data.trigger === 'number' && this.data.trigger > 0) {
            g += 'TRIGGER;RELATED=END:' + tools_1.toDurationString(this.data.trigger) + '\r\n';
        }
        else if (typeof this.data.trigger === 'number') {
            g += 'TRIGGER:' + tools_1.toDurationString(this.data.trigger) + '\r\n';
        }
        else {
            g += 'TRIGGER;VALUE=DATE-TIME:' + tools_1.formatDate(this.event.timezone(), this.data.trigger) + '\r\n';
        }
        // REPEAT
        ...
        if (this.data.interval) {
            g += 'DURATION:' + tools_1.toDurationString(this.data.interval) + '\r\n';
        }
        // ATTACH
        ...
        if (this.data.type === 'display' && this.data.description) {
            g += 'DESCRIPTION:' + tools_1.escape(this.data.description) + '\r\n';
        }
        else if (this.data.type === 'display') {
            g += 'DESCRIPTION:' + tools_1.escape(this.event.summary()) + '\r\n';
        }
        // CUSTOM X ATTRIBUTES
